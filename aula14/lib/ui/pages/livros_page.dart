import 'package:aula09_db/bloc/livro_bloc.dart';
...
class _LivrosPageState extends State<LivrosPage> {
  ...
  void _abrirCadastro({Livro? livro}) async {
    await Navigator.push(context, MaterialPageRoute(builder: (context) => CadLivroPage(editora: widget.editora, livro: livro)));
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return ItemLista(
          ...
          listaAcoes: [
            IconButton(onPressed: (){ _abrirCadastro(livro: lista[index]); }, icon: const Icon(Icons.edit_note)),
            IconButton(onPressed: (){
              bloc.excluir(codigo: lista[index].codigo);
              setState() {}

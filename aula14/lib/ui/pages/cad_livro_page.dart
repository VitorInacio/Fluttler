...
import '../widgets/botao_quadrado.dart';
...
class _CadLivroPageState extends State<CadLivroPage> {
  ...
  Widget build(BuildContext context) {
    final bloc = LivroBloc(context: context, editora: widget.editora, livro: widget.livro);
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            CampoTexto(controller: bloc.precoController, texto: "Preço", teclado: TextInputType.number),
            Row(

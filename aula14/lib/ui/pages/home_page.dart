import 'package:aula09_db/bloc/editora_bloc.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _criarItem(Editora editora) {
    return ItemLista(
        ...
        clique: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => LivrosPage(editora)));
        },
    );
  }

  void _abrirCadastro({Editora? editora}) async {
    await Navigator.push(context, MaterialPageRoute(builder: (context) => CadEditoraPage(editora: editora)));
